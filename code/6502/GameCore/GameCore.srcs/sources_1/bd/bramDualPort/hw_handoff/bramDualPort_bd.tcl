...
################################################################
# This is a generated script based on design: bramDualPort
#
...
# source bramDualPort_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set wen_a [ create_bd_port -dir I wen_a ]
  set wen_b [ create_bd_port -dir I wen_b ]

  # Create instance: blk_mem_gen_0, and set properties
  set blk_mem_gen_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.2 blk_mem_gen_0 ]
  set_property -dict [ list CONFIG.Byte_Size {9} CONFIG.Coe_File {no_coe_file_loaded} CONFIG.Enable_32bit_Address {false} CONFIG.Enable_B {Use_ENB_Pin} CONFIG.Fill_Remaining_Memory_Locations {true} CONFIG.Load_Init_File {false} CONFIG.Memory_Type {True_Dual_Port_RAM} CONFIG.Port_B_Clock {100} CONFIG.Port_B_Enable_Rate {100} CONFIG.Port_B_Write_Rate {50} CONFIG.Read_Width_A {4} CONFIG.Read_Width_B {4} CONFIG.Register_PortA_Output_of_Memory_Primitives {true} CONFIG.Register_PortB_Output_of_Memory_Primitives {true} CONFIG.Use_Byte_Write_Enable {false} CONFIG.Use_RSTA_Pin {false} CONFIG.Write_Depth_A {307200} CONFIG.Write_Width_A {4} CONFIG.Write_Width_B {4} CONFIG.use_bram_block {Stand_Alone}  ] $blk_mem_gen_0
  ...
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_ports color_out] [get_bd_pins blk_mem_gen_0/doutb]
  ...
  connect_bd_net -net we_a_1 [get_bd_ports wen_a] [get_bd_pins blk_mem_gen_0/wea]
  connect_bd_net -net we_b_1 [get_bd_ports wen_b] [get_bd_pins blk_mem_gen_0/web]
